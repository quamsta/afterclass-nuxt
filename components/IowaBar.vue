<template>
  <div
    class="iowa-bar container-fluid iowa-bar--narrow iowa-bar--dark-header"
    data-uids-header
  >
    <div class="iowa-bar__container">
      ...
      <nav aria-labelledby="uids-toplinks" class="uids-toplinks">
        <h2 class="sr-only" id="uids-toplinks">Top links</h2>
        <ul class="nav uids-toplinks__menu">
          <li class="nav-item uids-toplinks__item mx-2">
            <a href="https://studentlife.uiowa.edu" class="uids-toplinks__link"
